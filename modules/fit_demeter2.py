...
if (args.sh_targets is not None) && os.path.exists(args.sh_targets):
...
if (args.pos_cons is not None) && os.path.exists(args.pos_cons):
...
if (args.neg_cons is not None) && os.path.exists(args.neg_cons):
