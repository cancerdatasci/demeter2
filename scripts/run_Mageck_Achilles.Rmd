...
build_mageck_inputs <- function(data_path, sh_targets, remove_list) {
...
for (cur_CL in cur_CLs) {
  ...
  cmd <- sprintf('/Users/jmmcfarl/anaconda/bin/mageck mle -k ~/CPDS/mageck_temp_data/counts_mat_solo.txt -d ~/CPDS/mageck_temp_data/design_mat_solo.txt -n %s --no-permutation-by-group --threads 6 --permutation-round 0 --norm-method total', cur_CL) 
  system(cmd)
}
```
...
for (cur_CL in cur_CLs) {
  ...
  cmd <- sprintf('/Users/jmmcfarl/anaconda/bin/mageck mle -k ~/CPDS/mageck_temp_data/counts_mat_solo.txt -d ~/CPDS/mageck_temp_data/design_mat_solo.txt -n %s --no-permutation-by-group --threads 2 --permutation-round 0 --norm-method total', cur_CL) 
  system(cmd)
}
```
