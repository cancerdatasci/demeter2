...
fig_dir <- '~/CPDS/demeter2/results/figures_oldreg'
...
print(with(df, cor.test(AGO2_GE, Ach_GA_ssmd)))

print('AGO2-SSMD cor DRIVE')
print(with(df, cor.test(AGO2_GE, DRIVE_GA_ssmd)))
...
print('Avg_SD vs gene_slope cor')
